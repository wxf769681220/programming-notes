<template>
  <div class="object-2" ref="object2">
  ...
  <code>
    ...
    <div class="card-column">
      <div class="card-column-content">
        <div class="card-column-title">4、组合模式</div>
        <div class="card-group">
          <div class="card">
            <div class="card-header">
  ...
  <code>
    ...
    <div class="card-column">
      <div class="card-column-content">
        <div class="card-column-title">6、动态原型</div>
        <div class="card-group">
          <div class="card">
            <div class="card-header">
  ...
  <code>
    ...
    <div class="card-column">
      <div class="card-column-content">
        <div class="card-column-title">7、寄生构造函数模式</div>
        <div class="card-group">
          <div class="card">
            <div class="card-header">
  ...
  <code>
    ...
    <div class="card-column">
      <div class="card-column-content">
        <div class="card-column-title">8、稳妥构造函数模式</div>
        <div class="card-group">
          <div class="card">
            <div class="card-header">
