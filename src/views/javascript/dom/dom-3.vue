        ...
        <div class="card-group">
          <div class="card">
            <div class="card-body">
              ...
              <ul>
                <li><strong class="danger">querySelector()</strong> 方法：接收一个 css 选择符，返回与该模式匹配的第一个元素。若没有找到匹配的元素，返回 null。</li>
                <li><strong class="danger">querySelectorAll()</strong> 方法：接收一个 css 选择符，返回与该模式匹配的所有元素。若没有找到匹配的元素，返回一个空的 nodeList 对象。</li>
                <li><strong class="danger">matchesSelector()</strong> 方法：接收一个 css 选择符。如果存在匹配元素，则返回 true，否则返回 false。（浏览器尚未支持）</li>
              </ul>
              <pre v-highlight>
<code>
  // 只返回匹配到的第一个元素
  ...
  document.body.innerHTML = "&lt;script>alert('hello world')&lt;/script>"
          ...
          <div class="card">
            <div class="card-header">
              <strong class="danger">window.toStaticHTML()</strong> 方法。
            </div>
            <div class="card-body">
              <p>只要是使用 innerHTML 从外部插入的 HTML，都应该以可靠的方式处理 HTML。window.toStaticHTML() 方法，接收一个 HTML 字符串，返回一个可靠的处理后的版本。
              即从源 HTML 中删除所有脚本节点和事件处理器。</p>
              <pre v-highlight>
<code>
    ...
    <div class="card-column">
      <div class="card-column-content">
        ...
        <div class="card-group">
          <div class="card">
            <div class="card-header">
              <strong class="danger">insertAdjacentHTML()</strong> 方法，
            </div>
            <div class="card-body">
              <p>表示插入标记。这个方法接收两个参数：第一个参数表示：插入位置；第二个参数表示：插入的 HTML文本。第一个参数必须是下列值：</p>
              <ul>
                <li><strong>beforebegin</strong>： 在当前元素之前插入一个相邻的同胞元素。</li>
                <li><strong>afterend</strong>：在当前元素之后插入一个相邻的同胞元素。</li>
                <li><strong>afterbegin</strong>： 在当前元素之下插入一个新的子元素，使其成为该元素的第一个子元素。</li>
                <li><strong>beforeend</strong>： 在当前元素之下插入一个新的子元素，使其成为该元素的最后一个子元素。</li>
              </ul>
              <pre v-highlight>
<code>
