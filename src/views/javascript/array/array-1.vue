        ...
        <div class="card">
          <div class="card-header">
            <ul>
              ...
              <li>数组项可以保存任何数据类型。</li>
              <li>
                数组的长度可以动态调整，即可以随着数据的添加自动增长以容纳新的数据。
              </li>
            </ul>
          </div>
          <div class="card-body">
...
<code>
  ...
  arr => [11, 12]
          ...
          <div class="card-header">数组允许有可选的结尾的逗号。</div>
          <div class="card-body">
            <pre v-highlight>
<code>
  var arr = [,,,]
...
<code>
  ...
  arr2 => ["0", "1", "2"]
    ...
    <div class="card-column">
      <div class="card-column-title">2、稀疏数组</div>
      <div class="card-group">
        <div class="card">
          <div class="card-header">
            数组的
            <strong class="bold">length</strong> 属性决定了数组的长度。设置
            length 值时，若数组的实际数组项小于 length 的值，则使用 undefined
            值填充数组； 若数组的实际数组项大于 length 的值，
            那么数组将从末尾删除多余的数组项。
          </div>
          <div class="card-body">
            <pre v-highlight>
<code>
  ...
  arr => ["x", "y", "z"]
        ...
        <div class="card">
          <div class="card-header">
            稀疏数组就是包含从 0 开始的不连续索引的数组。稀疏数组的 length
            属性值大于数组项实际个数。
          </div>
          <div class="card-body">
            <pre v-highlight>
...
<code>
  for (var i = 0, len = arr.length; i &lt; len; i++) {
    ...
    <div class="card-column">
      <div class="card-column-title">3、类数组</div>
      <div class="card-group">
        <div class="card">
          <div class="card-header">
            类数组对象有哪些？
...
<code>
  ...
  o => { 0: 0, 1: 1, 2: 4, length: 3 }
        ...
        <div class="card">
          <div class="card-header">类数组对象没有继承自 <strong class="bold">Array.prototype</strong>，因此不能在他们的上面直接调用数组方法。
          尽管如此，我们可以间接的使用 <strong class="bold">Function.call</strong> 方法调用。
          </div>
          <div class="card-body">
            <pre v-highlight>
<code>
  ...
  Array.prototype.slice.call(o)     => [0, 1, 4, 9]
          ...
          <div class="card-header">
            表示网页结构的 HTMLCollection 对象就是一个类数组对象。
          </div>
          <div class="card-body">
            <pre v-highlight>
<code>
